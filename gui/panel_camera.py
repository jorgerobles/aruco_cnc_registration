...
CLEAN: Camera functionality ONLY - no hardware/machine configuration
"""
...
@event_aware()
class CameraPanel:
    """Compact camera connection and calibration panel - CAMERA ONLY"""
    ...
    def __init__(self, parent, camera_manager, logger: Optional[Callable] = None):
        ...
        self.log("CameraPanel initialized (camera functionality only)", "info")
